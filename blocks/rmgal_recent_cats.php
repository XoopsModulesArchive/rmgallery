<?
// $Id: rmgal_recent_cats.php,v 1.0 17/03/2005 12:01:00 AdminOne Exp $
//  ------------------------------------------------------------------------ //
...
function bshow_recent_cats(){
	global $xoopsDB, $xoopsUser;
	
	$block = array();
	
	$result = $xoopsDB->query("SELECT * FROM ".$xoopsDB->prefix("rmgal_categos")." ORDER BY idcat DESC LIMIT 0, 5 ;");
